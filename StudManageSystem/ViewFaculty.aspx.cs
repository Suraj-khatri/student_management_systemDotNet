...
public partial class ViewFaculty : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "select Name,Address,Gender,Age,UserName,MobileNo from tblReg where UserType='Faculty'";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            gvadminFaculty.DataSource = dt;
            gvadminFaculty.DataBind();
